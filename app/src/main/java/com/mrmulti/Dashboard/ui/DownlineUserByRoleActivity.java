...
public class DownlineUserByRoleActivity extends AppCompatActivity {
    ...
    public void hitApi() {
        if (UtilMethods.INSTANCE.isNetworkAvialable(this)) {
            try {
                UtilMethods.INSTANCE.DonUser(this,null, role.toString(),userId.toString(),new UtilMethods.ApiCallBack() {
                    @Override
                    public void onSucess(Object object) {
                        ...
                        if (userrole != null) {
                            ...
                            if (userrole.getUser() != null && userrole.getUser().size() > 0) {
                                ...
                                mAdapter = new UserRoleAdapter(userrole.getUser(),  DownlineUserByRoleActivity.this,"v" );
                                mLayoutManager = new LinearLayoutManager( DownlineUserByRoleActivity.this);
